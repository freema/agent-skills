...
| **[talk-prep](skills/talk-prep/)** | Prepare a talk that fits its slot and lands one idea — red thread (main idea ≠ topic), time budget (80 % of the slot, ~150 words/min, intro 20 % / core 70 % / close 10 %), 30-second opening, a close that adds nothing new, less-is-more slides, objection handling, timestamped talk track |
